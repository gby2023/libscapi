...
#define ENC_round(i)                                                                   \
    {                                                                                  \
        block1 = _mm_aesenc_si128(block1, (*(__m128i const *)(keys[0].KEY + i * 16))); \
    }

#define ENC_round_last(i)                                                                  \
    {                                                                                      \
        block1 = _mm_aesenclast_si128(block1, (*(__m128i const *)(keys[0].KEY + i * 16))); \
    }
