 ...
 * Privacy OT have two modes: one is on ByteArray and the second is on
 ...
 *
 * For more information see Protocol 7.2.1 page 179 of <i>Efficient Secure
 * Two-Party Protocols</i> by Hazay-Lindell. The pseudo code of this protocol
 * can be found in Protocol 4.2 of pseudo codes document at
...
class OTPrivacyOnlyDDHSenderAbs : public OTSender {
 ...
 protected:
   ...
   */
  OTPrivacyOnlyDDHSenderAbs(const shared_ptr<PrgFromOpenSSLAES>& random,
 ...
 * This class derived from OTPrivacyOnlyDDHSenderAbs and implements the
 ...
 *
 */
class OTPrivacyOnlyDDHOnGroupElementSender : public OTPrivacyOnlyDDHSenderAbs,
                                             PrivacyOnly {
 public:
  /**
   * Constructor that sets the given dlogGroup and random.
   ...
   */
  OTPrivacyOnlyDDHOnGroupElementSender(
 ...
 *
 */
class OTPrivacyOnlyDDHOnByteArraySender : public OTPrivacyOnlyDDHSenderAbs,
                                          PrivacyOnly {
 public:
  /**
   ...
   * @throws InvalidDlogGroupException if the given dlog is invalid.
   */
  OTPrivacyOnlyDDHOnByteArraySender(
      const shared_ptr<PrgFromOpenSSLAES>& random =
          make_shared<PrgFromOpenSSLAES>(),
      const shared_ptr<DlogGroup>& dlog =
          make_shared<OpenSSLDlogECF2m>("K-233"),
      ...
      : OTPrivacyOnlyDDHSenderAbs(random, dlog), kdf(kdf) {}
...
class OTPrivacyOnlyDDHReceiverAbs : public OTReceiver {
 ...
 protected:
   ...
   * @throws InvalidDlogGroupException if the given DlogGroup is not valid.
   */
  OTPrivacyOnlyDDHReceiverAbs(const shared_ptr<PrgFromOpenSSLAES>& random,
                              const shared_ptr<DlogGroup>& dlog);
 ...
 * This class derived from OTPrivacyOnlyDDHReceiverAbs and implements the
 * functionality related to the group element inputs.
 *
 * For more information see Protocol 7.2.1 page 179 of <i>Efficient Secure
 * Two-Party Protocols</i> by Hazay-Lindell. The pseudo code of this protocol
 * can be found in Protocol 4.2 of pseudo codes document at
 ...
 *
 */
class OTPrivacyOnlyDDHOnGroupElementReceiver
 ...
 public:
   ...
   * @throws InvalidDlogGroupException if the given dlog is invalid.
   */
  OTPrivacyOnlyDDHOnGroupElementReceiver(
      const shared_ptr<PrgFromOpenSSLAES>& random =
          make_shared<PrgFromOpenSSLAES>(),
      const shared_ptr<DlogGroup>& dlog =
          make_shared<OpenSSLDlogECF2m>("K-233"))
 ...
 *
 */
class OTPrivacyOnlyDDHOnByteArrayReceiver : public OTPrivacyOnlyDDHReceiverAbs,
                                            PrivacyOnly {
 private:
  shared_ptr<KeyDerivationFunction> kdf;  // Used in the calculation.
 ...
 public:
   ...
   * @throws InvalidDlogGroupException if the given dlog is invalid.
   */
  OTPrivacyOnlyDDHOnByteArrayReceiver(
      const shared_ptr<PrgFromOpenSSLAES>& random =
          make_shared<PrgFromOpenSSLAES>(),
      const shared_ptr<DlogGroup>& dlog =
          make_shared<OpenSSLDlogECF2m>("K-233"),
