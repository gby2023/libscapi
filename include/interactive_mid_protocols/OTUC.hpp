...
/**
 * Concrete class for OT sender based on the DDH assumption that achieves UC
 * security in the common reference string model. This implementation is based
 * on the protocol of Peikert, Vaikuntanathan and Waters (CRYPTO 2008) for
 * achieving UC-secure OT.
 *
 * This is implementation in GroupElement mode, derived from OTUCDDHSenderAbs
 * and implements the functionality related to the byte array inputs.
 *
 * The pseudo code of this protocol can be found in Protocol 4.6 of pseudo codes
 * document at <a
 * href="http://cryptobiu.github.io/scapi/SDK_Pseudocode.pdf">http://cryptobiu.github.io/scapi/SDK_Pseudocode.pdf</a>.<p>
 *
...
class OTUCDDHOnGroupElementSender : public OTSender, Malicious, UC {
 ...
 public:
   ...
   * description (G,q,g0) and (g0,g1,h0,h1) which is a randomly chosen non-DDH
   * tuple, kdf and random.
   */
  OTUCDDHOnGroupElementSender(
...
/**
 * Concrete class for OT receiver based on the DDH assumption that achieves UC
 * security in the common reference string model. This implementation is based
 * on the protocol of Peikert, Vaikuntanathan and Waters (CRYPTO 2008) for
 * achieving UC-secure OT.
 *
 * This is implementation in GroupElement mode, derived from OTUCDDHReceiverAbs
 * and implements the functionality related to the byte array inputs.
 *
 * The pseudo code of this protocol can be found in Protocol 4.6 of pseudo codes
 * document at <a
 ...
 * achieving UC-secure OT.
 *
 * This is implementation in BYTE ARRAY mode, derived from OTUCDDHSenderAbs and
 * implements the functionality related to the byte array inputs.
 *
 * The pseudo code of this protocol can be found in Protocol 4.6 of pseudo codes
 * document at <a
 * href="http://cryptobiu.github.io/scapi/SDK_Pseudocode.pdf">http://cryptobiu.github.io/scapi/SDK_Pseudocode.pdf</a>.<p>
 ...
 * achieving UC-secure OT.
 *
 * This is implementation in BYTE ARRAY mode, derived from OTUCDDHReceiverAbs
 * and implements the functionality related to the byte array inputs.
 *
 * The pseudo code of this protocol can be found in Protocol 4.6 of pseudo codes
 * document at <a
